      ...
      <div className="flex-1 flex items-center justify-center bg-slate-50 px-6 py-10">
        <div className="w-full max-w-sm space-y-8">
          <div>
            ...
            <p className="text-slate-500 mt-1 text-sm">Completá tus datos para registrarte</p>
          </div>
              ...
              {(field) => (
                <div className="space-y-1.5">
                  <label className="block text-sm font-medium text-slate-700">
                    Contraseña <span className="text-slate-400 font-normal">(mín. 8 caracteres)</span>
                  </label>
                  <input
                    type="password"
                    value={field.state.value}
